...
# Fuyao single-node LIBERO evaluation entrypoint for FastWAM.
#
# Submit example:
#   fuyao deploy <resource flags> \
#     bash scripts/eval_fuyao_libero.sh \
#       task=libero_future_cache_2cam224_1e-4 \
#       ckpt=/dataset_rc/.../checkpoints/weights/step_021700.pt \
#       EVALUATION.num_trials=50 \
#       MULTIRUN.max_tasks_per_gpu=2
#
# Environment-variable equivalents are also supported:
#   TASK_CONFIG=libero_joint_2cam224_1e-4 \
#   CKPT=/dataset_rc/.../step_021700.pt \
#   NUM_TRIALS=50 \
#   EVAL_OUTPUT_DIR=/dataset_rc/.../libero_eval \
#   bash scripts/eval_fuyao_libero.sh
#
# Inspect the resolved command without installing packages or starting evaluation:
#   DRY_RUN=1 bash scripts/eval_fuyao_libero.sh task=... ckpt=...
...
activate_conda_wam() {
  ...
  # The persistent environment was copied from /root/miniconda3. Select it
  # directly because generated activation scripts may retain the old prefix.
