...
class FinetuneConfig:
    ...
    """If True, enable the learned condition router (per-cross-attn-block mixture over
    candidate VLM layers) instead of the fixed final-layer tap."""

    router_candidate_layers: list[int] | None = None
    """Candidate pool as hidden_states indices (0 = embedding output, i = LLM layer i).
    None = all of range(select_layer + 1)."""
